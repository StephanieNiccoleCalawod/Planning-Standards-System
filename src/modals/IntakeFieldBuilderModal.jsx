...
export default function IntakeFieldBuilderModal({ service, onClose, onSave }) {
  const initialFields = service?.intakeFields || [
    { id: 1, label: "Duly filled Request Form", type: "Text", required: true, displayOrder: 1 },
    { id: 2, label: "Student Identification Card (ID)", type: "Checkbox", required: true, displayOrder: 2 },
    { id: 3, label: "Year Level / Section", type: "Dropdown", required: false, displayOrder: 3, options: ["1st Year", "2nd Year", "3rd Year", "4th Year"] },
  ];
