...
export default function HolidayCalendar() {
  ...
  const closeModal = () => { setShowModal(false); setEditingHoliday(null); setDeletingHoliday(null); };
              ...
              <div style={S.modalFooter}>
                {editingHoliday && (
                  <button
                    ...
                    onClick={() => setDeletingHoliday(editingHoliday)}
                  >
                    Delete
                  </button>
                )}
      ...
      {deletingHoliday && (
        <div style={{
          ...
          <style dangerouslySetInnerHTML={{
            ...
            .hc-delete-top { padding: 32px 32px 24px; }
            .hc-delete-icon-box {
            ...
            .hc-delete-btn-ghost:hover { background: #F8FAFC; border-color: #94A3B8; color: #0F172A; }
            .hc-delete-btn-confirm {
              padding: 9px 18px; font-size: 13.5px; font-weight: 600;
              color: #fff; background: #DC2626;
              border: none; border-radius: 8px;
              cursor: pointer; transition: all 0.15s;
            }
            .hc-delete-btn-confirm:hover { background: #B91C1C; }
          `}} />
          <div className="hc-delete-card">
            <div className="hc-delete-top">
              <div className="hc-delete-icon-box">
              ...
              <h3 className="hc-delete-title">Delete this holiday?</h3>
              <p className="hc-delete-desc">
                <span style={{ fontWeight: 600, color: "#0F172A" }}>{deletingHoliday.name}</span> will be permanently removed from the Holiday Calendar. This action cannot be undone.
              </p>
            </div>
            <div className="hc-delete-bar">
              <button className="hc-delete-btn-ghost" onClick={() => setDeletingHoliday(null)}>Cancel</button>
              <button
                className="hc-delete-btn-confirm"
                onClick={() => handleDelete(deletingHoliday.id, deletingHoliday.name)}
              >
                Delete Holiday
              </button>
            </div>
