...
export default function SLAConfiguration() {
    ...
    return (
        <Box sx={{ p: { xs: 2, sm: 3, md: 4 }, bgcolor: '#F8FAFC', minHeight: '100vh' }}>
                                        ...
                                        return (
                                            <Box key={item.id}>
                                                {showHeader && (
                                                    <Typography
                                                        variant="subtitle2"
                                                        sx={{ fontWeight: 700, color: 'text.secondary', mt: index === 0 ? 0 : 2.5, mb: 1.5, fontSize: '0.8125rem' }}
                                                    >
                                                        {monthYear}
                                                    </Typography>
                                                )}
                                                ...
                                                >
                                                    <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 1 }}>
                                                        <Box
                                                            ...
                                                            sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5, flexGrow: 1, userSelect: 'none' }}
                                                        >
                                                                ...
                                                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexWrap: 'wrap' }}>
                                                                    ...
                                                                    {item.is_active_rule && (
                                                                        <Chip
                                                                            ...
                                                                            size="small"
                                                                            color="success"
                                                                            sx={{ height: 18, fontSize: '0.625rem', fontWeight: 800, textTransform: 'uppercase', px: 0.5 }}
                                                                        />
                                                                    )}
                                                                </Box>
                                                                    ...
                                                                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.25, mt: 0.25 }}>
                                                                        {item.restored_dates.map((rd, rIdx) => (
                                                                            <Typography
                                                                                key={rIdx}
                                                                                variant="caption"
                                                                                sx={{ color: '#800000', fontWeight: 700, display: 'flex', alignItems: 'center', gap: 0.5 }}
                                                                            >
                                                        ...
                                                        {/* Restore and 3-dot menu — only visible for roles with SLA write permission */}
                                                        {canSeeSlaForm && (
            ...
            {/* ── Restore Existing Version Confirmation ── */}
            <ConfirmModal
            ...
            <Menu
                ...
                PaperProps={{
                    elevation: 3,
                    sx: { borderRadius: '8px', minWidth: 160, boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1), 0 2px 4px -1px rgba(0,0,0,0.06)' }
                }}
            >
                <MenuItem onClick={handleMenuRename} sx={{ fontSize: '0.8125rem', fontWeight: 500, py: 1 }}>
                    Name this version
                </MenuItem>
                <MenuItem onClick={handleCloseMenu} sx={{ fontSize: '0.8125rem', fontWeight: 500, py: 1 }}>
                    Make a copy
                </MenuItem>
            </Menu>
            ...
            <Dialog
                ...
                PaperProps={{ sx: { borderRadius: '8px', width: '100%', maxWidth: 400 } }}
            >
                ...
                <DialogActions sx={{ p: '12px 24px' }}>
                    <Button onClick={() => setRenamingItem(null)} sx={{ textTransform: 'none', fontWeight: 600, color: 'text.secondary' }}>
                        Cancel
                    </Button>
                    <Button
                        onClick={handleSaveName}
                        variant="contained"
                        sx={{ textTransform: 'none', fontWeight: 600, bgcolor: '#15803D', '&:hover': { bgcolor: '#166534' } }}
                    >
                        Save
                    </Button>
                </DialogActions>
