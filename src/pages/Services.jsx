...
export default function Services() {
  ...
  // Update services when mock data changes (if applicable) or keep local state for toggling
  // Since we use 'services' state for toggling active/inactive, we'll continue using it.
            ...
            {paginatedData.length > 0 ? (
              paginatedData.map((svc, i) => (
                <tr key={svc.id} style={{
                  ...
                  <td style={{ padding: "14px 16px", fontSize: 13, color: COLORS.muted }}>{svc.id}</td>
